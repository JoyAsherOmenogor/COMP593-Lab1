...
def main():
    ...
    about_me ={
        ...
        'movies': [
            ...
            {
                'title': 'Revelation', 'genre': 'Christian',
                'title': 'Summerville', 'genre': 'Romance
            },
    ...
    add_pizza_toppings(about_me, ['bacon', 'cheddar','onion'])
    print_pizza_toppings(about_me)

    # Step 6: Add another movie to the data structure
    # TODO: Change to a movie you like
    add_movie(about_me, ''Summerville!'', 'Romance')
...
def print_student_name_and_id(my_info):
    ...
    print(f"My name is {my_info['fullname']}, but you can call me Priceless {my_info['fullname'].split()[0]}.")
